      ...
      *> Entree : <nombre-de-codes> lignes de 9 chiffres sur stdin
      *> Sortie : une ligne "<CODE> - <REMISE>" par code
       ...
       01 WS-ENTROPY            PIC X(9)  VALUE SPACES.
       01 WS-ENTROPY-FIELDS REDEFINES WS-ENTROPY.
          05 WS-CODE-DIGITS     PIC 9(6).
      ...
      *> Consomme une ligne d'entropie et emet le code correspondant.
       EMIT-ONE-CODE.
           ...
           MOVE WS-CODE-DIGITS TO WS-RANDOM
